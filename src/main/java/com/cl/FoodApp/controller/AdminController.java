...
public class AdminController {
	...
	public ResponseEntity<ResponseStructure<Admin>> getAdminByEmail(@RequestParam String email, @RequestParam String password) {
		return service.getAdminByEmail(email, password);
	}
